package com.noxis.customloadinganimations
...
import androidx.compose.ui.unit.dp
import com.noxis.customloadinganimations.ui.theme.CustomLoadingAnimationsTheme
...
fun BlurredAnimatedTextPreview() {
    CustomLoadingAnimationsTheme {
        BlurredAnimatedText(text = "Test test")
    }
}
